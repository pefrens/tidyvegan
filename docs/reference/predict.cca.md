...
- newdata:
  ...
  [`cca`](https://pefrens.github.io/tidyvegan/reference/cca.md) result
...
- type:
  ...
  [`rda`](https://pefrens.github.io/tidyvegan/reference/cca.md). In
  [`capscale`](https://pefrens.github.io/tidyvegan/reference/dbrda.md)
  and [`dbrda`](https://pefrens.github.io/tidyvegan/reference/dbrda.md)
  the `"response"` gives the dissimilarities, and `"working"` the
  internal data structure analysed in the ordination. Alternative `"wa"`
  gives the site scores as weighted averages of the community data,
  `"lc"` the site scores as linear combinations of environmental data,
  and `"sp"` the species scores. In `predict.decorana` the alternatives
  are scores for `"sites"` or `"species"`.
...
[`dbrda`](https://pefrens.github.io/tidyvegan/reference/dbrda.md) and
[`capscale`](https://pefrens.github.io/tidyvegan/reference/dbrda.md)
give the dissimilarities with `type = "response"`, but these are not
additive. However, the `"working"` scores are additive for
[`capscale`](https://pefrens.github.io/tidyvegan/reference/dbrda.md)
(but not for
[`dbrda`](https://pefrens.github.io/tidyvegan/reference/dbrda.md)). The
`fitted` and `residuals` for
[`capscale`](https://pefrens.github.io/tidyvegan/reference/dbrda.md) and
[`dbrda`](https://pefrens.github.io/tidyvegan/reference/dbrda.md) will
...
matrix for [`cca`](https://pefrens.github.io/tidyvegan/reference/cca.md)
or [`rda`](https://pefrens.github.io/tidyvegan/reference/cca.md). The
...
[`capscale`](https://pefrens.github.io/tidyvegan/reference/dbrda.md).
This is often known as calibration, bioindication or environmental
