...
- ...:
  ...
  [`scores`](https://pefrens.github.io/tidyvegan/reference/scores.md),
  in graphical functions to underlying graphical functions.
...
which
[`scores`](https://pefrens.github.io/tidyvegan/reference/scores.md) can
extract results. Function `procrustes` passes extra arguments to
[`scores`](https://pefrens.github.io/tidyvegan/reference/scores.md),
[`scores.cca`](https://pefrens.github.io/tidyvegan/reference/plot.cca.md)
...
for obtaining objects for `procrustes`, and
[`mantel`](https://pefrens.github.io/tidyvegan/reference/mantel.md) for
an alternative to `protest` without need of dimension reduction. See
...
#> 0.08139939 0.22056788 0.25738223 0.40751353 2.46736673 
#> 
#> Rotation matrix:
#>            [,1]        [,2]
#> [1,] 0.99794236 -0.06411737
#> [2,] 0.06411737  0.99794236
#> 
#> Translation of averages:
#>               [,1]         [,2]
#> [1,] -2.602172e-17 3.735727e-18
#> 
#> Scaling of target:
#> [1] 0.778915
#> 
...
#> 0.25941233 0.17447774 0.39874249 0.58131540 0.33274124 0.11053582 0.20647482 
#>         16         28         13         14         20         25          7 
#> 0.24992983 0.38737480 0.32300066 0.24063350 0.08139939 0.19732133 0.48245391 
#>          5          6          3          4          2          9         12 
#> 0.90978857 0.22663432 0.22526557 0.72039485 2.46736673 0.24590608 0.17318195 
#>         10         11         21 
#> 0.25535212 0.43382663 0.38095028 
## IGNORE_RDIFF_END
```
