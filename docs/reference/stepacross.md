...
(see functions
[`vegdist`](https://pefrens.github.io/tidyvegan/reference/vegdist.md)
and [`dist`](https://rdrr.io/r/stats/dist.html)). The value of `path` is
...
[`vegdist`](https://pefrens.github.io/tidyvegan/reference/vegdist.md)
may be very strongly semi-metric, and shortest paths can change these
...
[`swan`](https://pefrens.github.io/tidyvegan/reference/beals.md) for an
alternative approach. Function `stepacross` is an essential component in
[`isomap`](https://pefrens.github.io/tidyvegan/reference/isomap.md) and
