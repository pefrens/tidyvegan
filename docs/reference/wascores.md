...
eigenvalue of
[`cca`](https://pefrens.github.io/tidyvegan/reference/cca.md) when only
...
[`cca`](https://pefrens.github.io/tidyvegan/reference/cca.md)). Repeated
use of `wascores` will converge to the first axis of unconstrained
correspondence analysis
([`ca`](https://pefrens.github.io/tidyvegan/reference/cca.md)) which
therefore is also known as Reciprocal Averaging (Hill 1973). Constrained
correspondence analysis
([`cca`](https://pefrens.github.io/tidyvegan/reference/cca.md)) is
