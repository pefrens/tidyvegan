...
[`eigenvals.decorana`](https://pefrens.github.io/tidyvegan/reference/eigenvals.md).
...
[`cca`](https://pefrens.github.io/tidyvegan/reference/cca.md), too.
...
with `scores` or
[`weights.decorana`](https://pefrens.github.io/tidyvegan/reference/cca.object.md).
...
[`cca`](https://pefrens.github.io/tidyvegan/reference/cca.md), but the
scaling of results vary (and the one in `decorana` corresponds to
`scaling = "sites"` and `hill = TRUE` in
[`cca`](https://pefrens.github.io/tidyvegan/reference/cca.md).). See
