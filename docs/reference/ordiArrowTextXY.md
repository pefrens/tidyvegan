...
- x:
  ...
  can determine suitable ordination scores or an object created by
  [`envfit`](https://pefrens.github.io/tidyvegan/reference/envfit.md),
  or a two-column matrix of coordinates of arrow heads on the two plot
  axes.
...
- display:
  ...
  [`scores`](https://pefrens.github.io/tidyvegan/reference/scores.md) or
  ...
  [`dbrda`](https://pefrens.github.io/tidyvegan/reference/dbrda.md)). If
...
- ...:
  ...
  [`scores`](https://pefrens.github.io/tidyvegan/reference/scores.md),
  and [`strwidth`](https://rdrr.io/r/graphics/strwidth.html) and
...
the midpoint of the text bounding box. Several ordination `plot` and
