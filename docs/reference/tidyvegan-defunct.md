...
[`adonis2`](https://pefrens.github.io/tidyvegan/reference/adonis.md),
but arguments `contr.unordered` and `contr.ordered` can set the
...
[`toCoda`](https://pefrens.github.io/tidyvegan/reference/oecosimu.md).
...
to read vegan NEWS (`news(package = "tidyvegan")`), and
