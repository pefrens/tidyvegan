...
[`dbrda`](https://pefrens.github.io/tidyvegan/reference/dbrda.md)) to
...
- object:
  ...
  If there are several result objects, they are compared against each
  other in the order they were supplied. For a single object, a test
  specified in `by` or an overall test is given.
...
[`cca`](https://pefrens.github.io/tidyvegan/reference/cca.md),
[`rda`](https://pefrens.github.io/tidyvegan/reference/cca.md),
[`dbrda`](https://pefrens.github.io/tidyvegan/reference/dbrda.md) to get
...
an analysis for single terms additions, which can be used in automatic
or semiautomatic model building (see
