...
with argument `binary = TRUE`. Many other indices are dissimilarity
indices as well.
...
[`adonis2`](https://pefrens.github.io/tidyvegan/reference/adonis.md) or
...
[`adonis2`](https://pefrens.github.io/tidyvegan/reference/adonis.md) for
any model, and
[`mantel`](https://pefrens.github.io/tidyvegan/reference/mantel.md) to
...
[`vegdist`](https://pefrens.github.io/tidyvegan/reference/vegdist.md)
has some canned alternatives. Functions
[`betadisper`](https://pefrens.github.io/tidyvegan/reference/betadisper.md),
[`adonis2`](https://pefrens.github.io/tidyvegan/reference/adonis.md) and
[`mantel`](https://pefrens.github.io/tidyvegan/reference/mantel.md) can
be used for analysing beta diversity objects. The returned
dissimilarities can be used in any distance-based methods, such as
