...
The function `ordistep` is modelled after
...
- R2permutations:
  ...
  [`cca`](https://pefrens.github.io/tidyvegan/reference/cca.md) using
  [`RsquareAdj`](https://pefrens.github.io/tidyvegan/reference/RsquareAdj.md).
...
[`rda`](https://pefrens.github.io/tidyvegan/reference/cca.md)).
Actually, constrained ordination methods do not have AIC, and therefore
the [`step`](https://rdrr.io/r/stats/step.html) may not be trusted. This
...
#> + A1        1 87.424 1.2965  0.170   
#> + Use       2 88.284 1.0510  0.420   
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
...
#> + Management  3 87.082 2.8400  0.005 **
#> + Moisture    3 87.707 2.5883  0.005 **
#> + Manure      4 89.232 1.9539  0.020 * 
#> + A1          1 89.591 1.9217  0.065 . 
#> + Use         2 91.032 1.1741  0.315   
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> Step: dune ~ Management 
...
#> 
#>          Df    AIC      F Pr(>F)
#> + Manure  3 85.762 1.1225  0.300
#> + A1      1 86.220 0.8359  0.555
#> + Use     2 86.842 0.8027  0.690
#> 
#> 
#> Call: rda(formula = dune ~ Management + Moisture, data = dune.env)
#> 
