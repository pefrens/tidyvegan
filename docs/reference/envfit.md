...
- ord:
  ...
  can be extracted (including a data frame or matrix of scores).
...
- display:
  ...
  [`dbrda`](https://pefrens.github.io/tidyvegan/reference/dbrda.md)). In
...
Analysis [`cca`](https://pefrens.github.io/tidyvegan/reference/cca.md)
and Redundancy analysis
([`rda`](https://pefrens.github.io/tidyvegan/reference/cca.md)), since
