...
to analyse the non-randomness of results.
...
[`nullmodel`](https://pefrens.github.io/tidyvegan/reference/nullmodel.md)s
...
out
#> nestedness temperature: 10.23638 
...
#> checkerboards      2767 0.50389 2720.9 2574.7 2718.0 2887.6     0.61
...
#> 
#>         statistic     SES   mean   2.5%    50%  97.5% Pr(sim.)   
#> C.score    2.2588 -24.512 9.2457 8.6921 9.2514 9.7256     0.01 **
#> ---
