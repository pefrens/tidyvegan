...
to assess if the solutions is likely a global optimum.
...
Function
[`metaMDS`](https://pefrens.github.io/tidyvegan/reference/metaMDS.md)
adds support functions so that NMDS can be run like recommended by
Minchin (1987).

## See also

[`metaMDS`](https://pefrens.github.io/tidyvegan/reference/metaMDS.md)
for the vegan way of running NMDS, and
