...
([`rda`](https://pefrens.github.io/tidyvegan/reference/cca.md)), but it
...
[`rda`](https://pefrens.github.io/tidyvegan/reference/cca.md), but dbRDA
...
- formula:
  ...
  defined in
  [`cca`](https://pefrens.github.io/tidyvegan/reference/cca.md) and
  [`rda`](https://pefrens.github.io/tidyvegan/reference/cca.md). The LHS
  ...
  or [`dist`](https://rdrr.io/r/stats/dist.html). If the LHS is a data
  matrix, function
  [`vegdist`](https://pefrens.github.io/tidyvegan/reference/vegdist.md)
  or function given in `dfun` will be used to find the dissimilarities.
  The RHS defines the constraints. The constraints can be continuous
  ...
  [`rda`](https://pefrens.github.io/tidyvegan/reference/cca.md) or
  [`cca`](https://pefrens.github.io/tidyvegan/reference/cca.md). This
...
- na.action:
  ...
  [`rda`](https://pefrens.github.io/tidyvegan/reference/cca.md), no WA
...
[`rda`](https://pefrens.github.io/tidyvegan/reference/cca.md).
`capscale` ignores the imaginary component and will not give negative
eigenvalues (but will report the magnitude on imaginary component).

If the user supplied a community data frame instead of dissimilarities,
the functions will find dissimilarities using
[`vegdist`](https://pefrens.github.io/tidyvegan/reference/vegdist.md) or
...
[`cca`](https://pefrens.github.io/tidyvegan/reference/cca.md) so that
...
inherit from
[`rda`](https://pefrens.github.io/tidyvegan/reference/cca.md). See
[`cca.object`](https://pefrens.github.io/tidyvegan/reference/cca.object.md)
...
[`cca.object`](https://pefrens.github.io/tidyvegan/reference/cca.object.md)).
This section for
[`rda`](https://pefrens.github.io/tidyvegan/reference/cca.md) gives a
more complete list of functions that can be used to access and analyse
dbRDA results.
