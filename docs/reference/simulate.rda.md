...
([`fitted.rda`](https://pefrens.github.io/tidyvegan/reference/predict.cca.md))
...
[`rda`](https://pefrens.github.io/tidyvegan/reference/cca.md). Internal
Chi-square transformed data are used in
[`cca`](https://pefrens.github.io/tidyvegan/reference/cca.md) within the
...
[`capscale`](https://pefrens.github.io/tidyvegan/reference/dbrda.md),
but the function returns the Euclidean distances calculated from the
...
[`capscale`](https://pefrens.github.io/tidyvegan/reference/dbrda.md))
with similar additional arguments on random number seed as
...
#> Total         85.2422     1.0000     
#> Constrained   61.2143     0.7181    6
#> Unconstrained 24.0278     0.2819   13
#> 
#> Inertia is variance
#> 
#> Eigenvalues for constrained axes:
#>   RDA1   RDA2   RDA3   RDA4   RDA5   RDA6 
#> 25.177 16.877  7.523  5.592  3.576  2.470 
#> 
#> Eigenvalues for unconstrained axes:
#>   PC1   PC2   PC3   PC4   PC5   PC6   PC7   PC8   PC9  PC10  PC11  PC12  PC13 
#> 5.436 3.913 2.919 2.713 2.099 1.678 1.381 1.178 1.117 0.535 0.467 0.367 0.223 
#> 
