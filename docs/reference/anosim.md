...
[`vegdist`](https://pefrens.github.io/tidyvegan/reference/vegdist.md).
The method is philosophically allied with NMDS ordination
...
a more robust alternative that should preferred.
