...
The tidyvegan package provides tools for descriptive community ecology.
It has most basic functions of diversity analysis, community ordination
and dissimilarity analysis. Most of its multivariate tools can be used
for other data types as well.

## Details

The functions in the tidyvegan package contain tools for diversity
analysis, ordination methods and tools for the analysis of
dissimilarities. Together with the labdsv package, the tidyvegan package
provides most standard tools of descriptive community analysis. Package
ade4 provides an alternative comprehensive package, and several other
packages complement tidyvegan and provide tools for deeper analysis in
specific fields. Package BiodiversityR provides a GUI for a large subset
of tidyvegan functionality.

The tidyvegan package is developed at GitHub
(<https://github.com/pefrens/tidyvegan/>). GitHub provides up-to-date
information and forums for bug reports.

Most important changes in tidyvegan documents can be read with
`news(package="tidyvegan")` and vignettes can be browsed with
`browseVignettes("tidyvegan")`. The vignettes include a tidyvegan FAQ,
...
Paul E. Santos Andrade <paulefrens@gmail.com> (creator and maintainer of
tidyvegan).

The original vegan development team is Jari Oksanen, F. Guillaume
Blanchet, Roeland Kindt, Pierre Legendre, Peter R. Minchin, R. B.
O'Hara, Gavin L. Simpson, Peter Solymos, M. Henry H. Stevens, Helene
...
#> Run 1 stress 0.2114005 
#> Run 2 stress 0.2094754 
#> Run 3 stress 0.2077995 
#> Run 4 stress 0.2092456 
#> Run 5 stress 0.2109006 
#> Run 6 stress 0.2146373 
#> Run 7 stress 0.2414244 
#> Run 8 stress 0.1843196 
#> ... Procrustes: rmse 4.210421e-06  max resid 1.414974e-05 
#> ... Similar to previous best
#> Run 9 stress 0.1974409 
#> Run 10 stress 0.2488936 
#> Run 11 stress 0.1962451 
#> Run 12 stress 0.2048307 
#> Run 13 stress 0.1825658 
#> ... New best solution
#> ... Procrustes: rmse 0.04162581  max resid 0.1518022 
#> Run 14 stress 0.2166093 
#> Run 15 stress 0.1858401 
#> Run 16 stress 0.195049 
#> Run 17 stress 0.2114464 
#> Run 18 stress 0.1948413 
#> Run 19 stress 0.1967393 
#> Run 20 stress 0.1974407 
...
#> 
#>             NMDS1    NMDS2     r2 Pr(>r)    
#> N        -0.05729 -0.99836 0.2536  0.037 *  
#> P         0.61970  0.78484 0.1938  0.138    
#> K         0.76644  0.64232 0.1809  0.137    
#> Ca        0.68518  0.72837 0.4119  0.005 ** 
#> Mg        0.63251  0.77456 0.4270  0.005 ** 
#> S         0.19136  0.98152 0.1752  0.163    
#> Al       -0.87161  0.49020 0.5269  0.001 ***
#> Fe       -0.93603  0.35192 0.4450  0.002 ** 
#> Mn        0.79871 -0.60171 0.5231  0.001 ***
#> Zn        0.61754  0.78654 0.1879  0.132    
#> Mo       -0.90308  0.42947 0.0609  0.513    
#> Baresoil  0.92490 -0.38021 0.2508  0.045 *  
#> Humdepth  0.93284 -0.36030 0.5200  0.001 ***
...
#> 
#>          Df    AIC      F Pr(>F)
#> + Manure  3 85.762 1.1225  0.335
#> + A1      1 86.220 0.8359  0.545
...
#> A1          1   0.1283 0.02983 0.9231  0.449
#> Moisture    3   0.6596 0.15343 1.5826  0.109
#> Management  2   0.1959 0.04556 0.7050  0.718
#> Use         2   0.1305 0.03036 0.4697  0.916
#> Manure      3   0.4208 0.09787 1.0096  0.445
