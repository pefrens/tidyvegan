...
with given
[`commsim`](https://pefrens.github.io/tidyvegan/reference/commsim.md),
and then generating a series of simulated communities with
[`simulate.nullmodel`](https://pefrens.github.io/tidyvegan/reference/nullmodel.md).
...
[`nullmodel`](https://pefrens.github.io/tidyvegan/reference/nullmodel.md)
and deprecation of
[`commsimulator`](https://pefrens.github.io/tidyvegan/reference/tidyvegan-defunct.md).

## See also

Function `oecosimu` currently defines null models with
[`commsim`](https://pefrens.github.io/tidyvegan/reference/commsim.md)
and generates the simulated null model communities with
[`nullmodel`](https://pefrens.github.io/tidyvegan/reference/nullmodel.md)
and
[`simulate.nullmodel`](https://pefrens.github.io/tidyvegan/reference/nullmodel.md).
...
#> checkerboards      2767 -21.823 8016.7 7511.8 8062.0 8420.3     0.01 **
#> ---
...
#> DCA1  0.382249  2.79746 0.31803 0.31907 0.3517     0.01 **
#> DCA2  0.261208  1.72262 0.21674 0.21954 0.2586     0.06 . 
#> DCA3  0.166788  0.24544 0.16051 0.16192 0.2010     0.44   
#> DCA4  0.087226 -1.90133 0.13187 0.12981 0.1706     0.99   
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
...
#> 
#>           statistic    SES    mean    2.5%     50%  97.5% Pr(sim.)   
#> statistic   0.64565 14.441 0.46405 0.43983 0.46424 0.4887     0.01 **
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
...
#> 
#>           statistic    SES    mean    2.5%     50% 97.5% Pr(sim.)   
#> statistic   0.64565 3.1816 0.63521 0.62940 0.63495 0.641     0.01 **
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
...
#> 
#>               statistic     SES   mean   2.5%    50%  97.5% Pr(sim.)
#> checkerboards      2767 0.22297 2750.5 2614.9 2754.0 2874.6     0.93
...
#> 
#>               statistic     SES   mean   2.5%    50% 97.5% Pr(sim.)
#> checkerboards      2767 0.60989 2712.2 2565.3 2700.0  2917   0.4819
## IGNORE_RDIFF_END
