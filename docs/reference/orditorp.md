...
- ...:
  ...
  [`text`](https://rdrr.io/r/graphics/text.html) and
  [`points`](https://rdrr.io/r/graphics/points.html).
...
[`scores`](https://pefrens.github.io/tidyvegan/reference/scores.md)
method for the ordination object (`x`) being drawn. See the relevant
[`scores`](https://pefrens.github.io/tidyvegan/reference/scores.md) help
