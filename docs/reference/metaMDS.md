...
[`monoMDS`](https://pefrens.github.io/tidyvegan/reference/monoMDS.md) is
...
- parallel:
  ...
  `clusterEvalQ(clus, library(tidyvegan))` to make available internal
  vegan functions. With `parallel = 1` uses ordinary, non-parallel
...
[`monoMDS`](https://pefrens.github.io/tidyvegan/reference/monoMDS.md).
In particular, if you reach the maximum number of iterations, you should
...
[`monoMDS`](https://pefrens.github.io/tidyvegan/reference/monoMDS.md))
in your `metaMDS` command,and you should check documentation of these
...
percents,
[`monoMDS`](https://pefrens.github.io/tidyvegan/reference/monoMDS.md)
and most other functions use proportions \\0 \ldots 1\\). The other
items store the information on the steps taken and the items returned by
the `engine` function. The object has `print`, `plot`, `points` and
`text` methods. Functions `metaMDSdist` and `metaMDSredist` return
[`vegdist`](https://pefrens.github.io/tidyvegan/reference/vegdist.md)
...
#> Run 3 stress 0.1812936 
#> Run 4 stress 0.1192678 
#> ... Procrustes: rmse 2.745215e-05  max resid 8.162387e-05 
#> ... Similar to previous best
#> Run 5 stress 0.1192679 
#> ... Procrustes: rmse 0.0001468327  max resid 0.0004497557 
#> ... Similar to previous best
#> Run 6 stress 0.1183186 
#> ... New best solution
#> ... Procrustes: rmse 0.02026924  max resid 0.06495708 
#> Run 7 stress 0.1183186 
#> ... Procrustes: rmse 5.183183e-06  max resid 1.232675e-05 
#> ... Similar to previous best
#> Run 8 stress 0.1922242 
#> Run 9 stress 0.1192679 
#> Run 10 stress 0.1192679 
#> Run 11 stress 0.1809577 
...
#> ... New best solution
#> ... Procrustes: rmse 1.138821e-05  max resid 3.579996e-05 
#> ... Similar to previous best
...
#> ... Procrustes: rmse 4.490603e-06  max resid 1.160928e-05 
#> ... Similar to previous best
#> Run 3 stress 0.1192678 
#> Run 4 stress 0.1192678 
#> Run 5 stress 0.1183186 
#> ... Procrustes: rmse 2.628518e-05  max resid 7.661707e-05 
#> ... Similar to previous best
#> Run 6 stress 0.1183186 
#> ... New best solution
#> ... Procrustes: rmse 3.895823e-06  max resid 1.058873e-05 
#> ... Similar to previous best
#> Run 7 stress 0.1808911 
#> Run 8 stress 0.1192678 
#> Run 9 stress 0.1192678 
#> Run 10 stress 0.1183186 
#> ... Procrustes: rmse 1.156381e-05  max resid 3.661003e-05 
#> ... Similar to previous best
#> Run 11 stress 0.1192678 
#> Run 12 stress 0.1812932 
#> Run 13 stress 0.1183186 
#> ... Procrustes: rmse 1.332638e-06  max resid 3.466646e-06 
#> ... Similar to previous best
#> Run 14 stress 0.1183186 
#> ... Procrustes: rmse 1.529952e-05  max resid 4.924104e-05 
#> ... Similar to previous best
#> Run 15 stress 0.1192678 
...
#> ... Procrustes: rmse 3.973775e-06  max resid 1.11842e-05 
#> ... Similar to previous best
...
#> ... New best solution
#> ... Procrustes: rmse 0.0001529959  max resid 0.0004445145 
#> ... Similar to previous best
#> Run 2 stress 0.1928475 
#> ... New best solution
#> ... Procrustes: rmse 0.0001764448  max resid 0.0004980405 
#> ... Similar to previous best
#> Run 3 stress 0.1928477 
#> ... Procrustes: rmse 0.0001418817  max resid 0.0004117547 
#> ... Similar to previous best
#> Run 4 stress 0.1928479 
#> ... Procrustes: rmse 0.0002230815  max resid 0.0006515424 
#> ... Similar to previous best
#> Run 5 stress 0.1928475 
#> ... New best solution
#> ... Procrustes: rmse 5.31448e-05  max resid 0.0001510707 
#> ... Similar to previous best
#> Run 6 stress 0.1928477 
#> ... Procrustes: rmse 0.0001898018  max resid 0.0005439187 
#> ... Similar to previous best
#> Run 7 stress 0.1928477 
#> ... Procrustes: rmse 0.0002216065  max resid 0.0006019047 
#> ... Similar to previous best
#> Run 8 stress 0.1928495 
#> ... Procrustes: rmse 0.0005866221  max resid 0.001662619 
#> ... Similar to previous best
#> Run 9 stress 0.1928476 
#> ... Procrustes: rmse 0.0001606607  max resid 0.000476204 
#> ... Similar to previous best
#> Run 10 stress 0.1928481 
#> ... Procrustes: rmse 0.0003467366  max resid 0.001014388 
#> ... Similar to previous best
#> Run 11 stress 0.1928475 
#> ... Procrustes: rmse 8.118614e-05  max resid 0.0002340604 
#> ... Similar to previous best
#> Run 12 stress 0.1928479 
#> ... Procrustes: rmse 0.0002649401  max resid 0.0007863535 
#> ... Similar to previous best
#> Run 13 stress 0.1928476 
#> ... Procrustes: rmse 0.0002028689  max resid 0.0005408595 
#> ... Similar to previous best
#> Run 14 stress 0.1928478 
#> ... Procrustes: rmse 0.0002561421  max resid 0.0007466492 
#> ... Similar to previous best
#> Run 15 stress 0.1928477 
#> ... Procrustes: rmse 0.0002266304  max resid 0.0005855547 
#> ... Similar to previous best
#> Run 16 stress 0.1928482 
#> ... Procrustes: rmse 0.0003707363  max resid 0.001073148 
#> ... Similar to previous best
#> Run 17 stress 0.192849 
#> ... Procrustes: rmse 0.0004977024  max resid 0.001483066 
#> ... Similar to previous best
#> Run 18 stress 0.1928475 
#> ... Procrustes: rmse 5.145495e-05  max resid 0.0001414972 
#> ... Similar to previous best
#> Run 19 stress 0.1928478 
#> ... Procrustes: rmse 0.0002647514  max resid 0.000726045 
#> ... Similar to previous best
#> Run 20 stress 0.1928475 
#> ... Procrustes: rmse 1.819148e-05  max resid 5.503843e-05 
#> ... Similar to previous best
...
#> ... Procrustes: rmse 9.086225e-06  max resid 2.383554e-05 
#> ... Similar to previous best
#> Run 2 stress 0.107471 
#> Run 3 stress 0.1069784 
#> ... Procrustes: rmse 0.006728765  max resid 0.02366609 
#> Run 4 stress 0.1073148 
#> Run 5 stress 0.1067169 
#> ... Procrustes: rmse 1.795616e-05  max resid 4.730123e-05 
#> ... Similar to previous best
#> Run 6 stress 0.1840618 
#> Run 7 stress 0.1067169 
#> ... Procrustes: rmse 2.489391e-06  max resid 6.711696e-06 
#> ... Similar to previous best
#> Run 8 stress 0.1689524 
#> Run 9 stress 0.1067169 
#> ... Procrustes: rmse 3.110658e-06  max resid 9.6555e-06 
#> ... Similar to previous best
#> Run 10 stress 0.1851919 
#> Run 11 stress 0.1784883 
#> Run 12 stress 0.1067169 
#> ... New best solution
#> ... Procrustes: rmse 4.167177e-06  max resid 1.132031e-05 
#> ... Similar to previous best
#> Run 13 stress 0.1067169 
#> ... Procrustes: rmse 4.030752e-06  max resid 1.248953e-05 
#> ... Similar to previous best
#> Run 14 stress 0.1067169 
#> ... Procrustes: rmse 2.244651e-06  max resid 5.41663e-06 
#> ... Similar to previous best
#> Run 15 stress 0.1067169 
#> ... Procrustes: rmse 3.155064e-06  max resid 7.720163e-06 
#> ... Similar to previous best
#> Run 16 stress 0.107471 
#> Run 17 stress 0.1073148 
#> Run 18 stress 0.1067169 
#> ... New best solution
#> ... Procrustes: rmse 2.603368e-06  max resid 8.498612e-06 
#> ... Similar to previous best
#> Run 19 stress 0.1069787 
#> ... Procrustes: rmse 0.006824107  max resid 0.02409612 
