...
[`commsim`](https://pefrens.github.io/tidyvegan/reference/commsim.md)
and give an error. If you want to handle smoothly error cases, you
should wrap `simulate` in [`try`](https://rdrr.io/r/base/try.html) or
...
cl <- makeCluster(3)
clusterEvalQ(cl, library(tidyvegan))
