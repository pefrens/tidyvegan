...
from [`cca`](https://pefrens.github.io/tidyvegan/reference/cca.md),
...
[`cca`](https://pefrens.github.io/tidyvegan/reference/cca.md)) to find
the fitted values of dependent community data, and constrained
ordination is based on this fitted response (Legendre & Legendre 2012).
The [`hatvalues`](https://rdrr.io/r/stats/influence.measures.html) give
the leverage values of these constraints, and the leverage is
independent on the response data. Other influence statistics
([`rstandard`](https://rdrr.io/r/stats/influence.measures.html),
...
[`cca`](https://pefrens.github.io/tidyvegan/reference/cca.md) the
...
for [`rda`](https://pefrens.github.io/tidyvegan/reference/cca.md) the
