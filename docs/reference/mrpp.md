...
[`vegdist`](https://pefrens.github.io/tidyvegan/reference/vegdist.md) to
...
which seems not suffer from the same problems as `mrpp` and is a more
robust alternative.

## See also

[`anosim`](https://pefrens.github.io/tidyvegan/reference/anosim.md) for
a similar test based on ranks, and
...
[`adonis2`](https://pefrens.github.io/tidyvegan/reference/adonis.md) is
a more robust alternative in most cases.
