...
[`ordisurf`](https://pefrens.github.io/tidyvegan/reference/ordisurf.md)).
...
as is dbRDA's unconstrained variant, principal coordinates analysis
(PCO). All these functions return similar objects (described in
[`cca.object`](https://pefrens.github.io/tidyvegan/reference/cca.object.md)).
...
response curves
([`prc`](https://pefrens.github.io/tidyvegan/reference/prc.md)) and
