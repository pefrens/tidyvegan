...
`ordixyplot` <-
    function(x, data = NULL, formula, display = "sites", choices=1:3,
             ...
             type = c("p", "biplot"),  ...)
{
    .Defunct("ggtidyvegan::autoplot", package = "tidyvegan")
}
...
{
    .Defunct("ggtidyvegan::autoplot for permustats", package = "tidyvegan")
}
...
{
    .Defunct("vegan3d::ordilattice3d", package="tidyvegan")
}
...
{
    .Defunct("influence.cca to extract residuals etc.", package="tidyvegan")
}
...
{
    .Defunct("adonis2", package="tidyvegan")
}
...
`as.mlm` <-
    function(x)
{
    .Defunct("influence.cca", package = "tidyvegan")
}
...
{
    .Defunct("simulate(nullmodel(x, method))", package="tidyvegan")
}
    ...
    function(x)
{
    ...
    ## coda
    .Defunct("toCoda", package = "tidyvegan")
}
