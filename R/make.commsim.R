    ...
    function(method)
{
    algos <- list(
        ...
        fun=function(x, n, nr, nc, rs, cs, rf, cf, s, fill, thin) {
            ...
            .Call(do_qswap, out, n, thin, "quasiswap", PACKAGE = "tidyvegan")
        }),
        "greedyqswap" = commsim(method="greedyqswap", binary=TRUE,
            ...
            out <- array(unlist(r2dtable(n, rs, cs)), c(nr, nc, n))
            storage.mode(out) <- "integer"
            .Call(do_greedyqswap, out, n, thin, fill, PACKAGE = "tidyvegan")
        }),
        ...
        fun = function(x, n, nr, nc, rs, cs, rf, cf, s, fill, thin) {
            ...
            .Call(do_swap, as.matrix(x), n, thin, "swap", PACKAGE = "tidyvegan")
        }),
        ...
        fun = function(x, n, nr, nc, rs, cs, rf, cf, s, fill, thin) {
            if (nr < 2L || nc < 2L)
                stop(sQuote(method)," needs at least two items", call. = FALSE)
            .Call(do_swap, as.matrix(x), n, thin, "trialswap", PACKAGE = "tidyvegan")
        }),
        ...
        fun = function(x, n, nr, nc, rs, cs, rf, cf, s, fill, thin) {
            ...
            .Call(do_curveball, as.matrix(x), n, thin, PACKAGE = "tidyvegan")
        }),
        "backtrack" = commsim(method="backtrack", binary = TRUE,
                               isSeq = FALSE, mode = "integer",
        fun = function(x, n, nr, nc, rs, cs, rf, cf, s, fill, thin) {
            .Call(do_backtrack, n, rs, cs, PACKAGE = "tidyvegan")
        }),
        ...
        fun = function(x, n, nr, nc, rs, cs, rf, cf, s, fill, thin) {
            ...
            if (nestedchecker(x)$statistic == 0)
                stop(sQuote(method), " needs checkerboard data: check with nestedchecker(x)", call. = FALSE)
            .Call(do_swap, as.matrix(x), n, thin, "swapcount", PACKAGE = "tidyvegan")
        }),
        ...
        fun=function(x, n, nr, nc, rs, cs, rf, cf, s, fill, thin) {
            ...
            out <- array(unlist(r2dtable(n, rs, cs)), c(nr, nc, n))
            storage.mode(out) <- "integer"
            .Call(do_qswap, out, n, fill, "rswapcount", PACKAGE = "tidyvegan")
        }),
        ...
        fun=function(x, n, nr, nc, cs, rs, rf, cf, s, fill, thin) {
            ...
            if (nestedchecker(x)$statistic == 0)
                stop(sQuote(method), " needs checkerboard data: check with nestedchecker(x)", call. = FALSE)
            .Call(do_abuswap, as.matrix(x), n, thin, 1L, PACKAGE = "tidyvegan")
        }),
        ...
        fun=function(x, n, nr, nc, cs, rs, rf, cf, s, fill, thin) {
            ...
            if (nestedchecker(x)$statistic == 0)
                stop(sQuote(method), " needs checkerboard data: check with nestedchecker(x)", call. = FALSE)
            .Call(do_abuswap, as.matrix(x), n, thin, 0L, PACKAGE = "tidyvegan")
        }),
